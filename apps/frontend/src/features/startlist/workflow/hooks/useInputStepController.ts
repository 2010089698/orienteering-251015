...
export const useInputStepController = () => {
  ...
  return {
    ...
    settingsForm: {
      ...
      laneIntervalMs: settingsForm.laneIntervalMs,
      playerIntervalMs: settingsForm.playerIntervalMs,
      laneCount: settingsForm.laneCount,
      avoidConsecutiveClubs: settingsForm.avoidConsecutiveClubs,
      laneIntervalOptions: settingsForm.laneIntervalOptions,
      playerIntervalOptions: settingsForm.playerIntervalOptions,
      status: settingsForm.status,
      onStartTimeChange: settingsForm.onStartTimeChange,
      onLaneIntervalChange: settingsForm.onLaneIntervalChange,
      onPlayerIntervalChange: settingsForm.onPlayerIntervalChange,
      onLaneCountChange: settingsForm.onLaneCountChange,
      onAvoidConsecutiveClubsChange: settingsForm.onAvoidConsecutiveClubsChange,
